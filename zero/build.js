...
const js = ['js/vault.js', 'js/storage.js', 'js/abilities.js', 'js/app.js']
...
if (out.includes('css/styles.css') || out.includes('js/app.js') || out.includes('js/vault.js') || out.includes('js/abilities.js') || out.includes('js/storage.js')) {
